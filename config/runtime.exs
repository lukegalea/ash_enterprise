...
#
#     PHX_SERVER=true bin/ash_enterprise start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ash_enterprise, AshEnterpriseWeb.Endpoint, server: true
end
  ...
  config :ash_enterprise, AshEnterpriseWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/ash_enterprise_web/router\.ex$",
        ~r"lib/ash_enterprise_web/(controllers|live|components)/.*\.(ex|heex)$"
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :ash_enterprise, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :ash_enterprise, AshEnterprise.Mailer,
